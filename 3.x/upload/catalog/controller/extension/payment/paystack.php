...
class ControllerExtensionPaymentPaystack extends Controller {
	public function index()
    {
        ...
        if ($order_info) {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/paystack.twig')) {
                return $this->load->view($this->config->get('config_template') . '/template/payment/paystack.twig', $data);
            } else {
                return $this->load->view('payment/paystack.twig', $data);
